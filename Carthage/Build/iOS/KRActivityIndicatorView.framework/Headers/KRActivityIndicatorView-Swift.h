...
@interface KRActivityIndicatorView : UIView
...
@property (nonatomic, readonly, strong) UIColor * _Nonnull headColor;
/// Activity indicator’s tail color (read-only).
/// You can set tail color from IB.
/// If you want to change color from code, use colors property.
@property (nonatomic, readonly, strong) UIColor * _Nonnull tailColor;
/// Number of dots
