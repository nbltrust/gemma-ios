...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MonkeyKing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class UIImage;

SWIFT_CLASS("_TtC10MonkeyKing11AnyActivity")
...
SWIFT_CLASS("_TtC10MonkeyKing10MonkeyKing")
@interface MonkeyKing : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface MonkeyKing (SWIFT_EXTENSION(MonkeyKing)) <WKNavigationDelegate>
