...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TagListView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic) NSLineBreakMode tagLineBreakMode;
...
typedef SWIFT_ENUM(NSInteger, Alignment, closed) {
  AlignmentLeft = 0,
  AlignmentCenter = 1,
  AlignmentRight = 2,
};
