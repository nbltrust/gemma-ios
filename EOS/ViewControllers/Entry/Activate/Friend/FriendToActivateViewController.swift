//
//  FriendToActivateViewController.swift
//  EOS
//
...
class FriendToActivateViewController: BaseViewController, IndicatorInfoProvider {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let text = R.string.localizable.friend_activate_title.key.localized()
        let highLightText = R.string.localizable.active_title_highlight.key.localized()
        self.contentView.setContentAttribute(contentLabelStr: text, attLabelArray: ["signupeoseos", highLightText])
    }
...
//extension FriendToActivateViewController: UITableViewDataSource, UITableViewDelegate {
...
//extension FriendToActivateViewController {
...
extension FriendToActivateViewController {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(stringLiteral: R.string.localizable.friend_to_activate.key.localized())
    }
}
