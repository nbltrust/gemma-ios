//
//  WalletCurrencyListViewController.swift
//  EOS
//
...
class WalletCurrencyListViewController: BaseViewController {
    ...
    override func configureObserveState() {
        self.coordinator?.state.context.asObservable().subscribe(onNext: { [weak self] (context) in
            ...
            if let context = context as? WalletCurrencyListContext {
...
//extension WalletCurrencyListViewController: UITableViewDataSource, UITableViewDelegate {
