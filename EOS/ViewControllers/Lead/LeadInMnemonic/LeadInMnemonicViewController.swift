...
class LeadInMnemonicViewController: BaseViewController {
    ...
    override func configureObserveState() {
        self.coordinator?.state.context.asObservable().subscribe(onNext: { [weak self] (context) in
            ...
            if let context = context as? LeadInMnemonicContext {
...
//extension LeadInMnemonicViewController: UITableViewDataSource, UITableViewDelegate {
