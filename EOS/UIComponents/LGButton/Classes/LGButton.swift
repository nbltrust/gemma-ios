...
public class LGButton: UIControl {
    ...
    @IBInspectable public var btn_cornerRadius: CGFloat = 0.0 {
        didSet {
            setupView()
        }
    }
    ...
    @IBInspectable public var btn_borderColor: UIColor = UIColor.white {
        didSet {
            setupView()
        }
    }

    @IBInspectable public var btn_borderWidth: CGFloat = 0.0 {
        didSet {
            setupView()
        }
    }
    ...
    @IBInspectable public var btn_shadowOffset: CGSize = CGSize.init(width: 0, height: 0) {
        didSet {
            setupView()
        }
    }

    @IBInspectable public var btn_shadowRadius: CGFloat = 0 {
        didSet {
            setupView()
        }
    }

    @IBInspectable public var btn_shadowOpacity: CGFloat = 1 {
        didSet {
            setupView()
        }
    }

    @IBInspectable public var btn_shadowColor: UIColor = UIColor.black {
        didSet {
            setupView()
        }
    }
    ...
    fileprivate func setupBorderAndCorners() {
        if fullyRoundedCorners {
            ...
            bgContentView.layer.cornerRadius = btn_cornerRadius
            layer.cornerRadius = btn_cornerRadius
        }
        bgContentView.layer.borderColor = btn_borderColor.cgColor
        bgContentView.layer.borderWidth = btn_borderWidth
    }
