...
namespace eosio {
    namespace wallet {
        ...
        public:
            ...
            static string get_cipher( const string& password, const string& priv_key);
            static string get_private_key( const string& password, const string& cipher);
            static string sign_transaction(const string& priv_key_str, const string& contract, const string& senderstr, const string& recipientstr, const string& amountstr,
            ...
            static string create_abi(const string& code, const string& action, const string& from, const string& to, const string& quantity);
            ...
            static pair<string, string> create_key(const std::string& key_type);
            string create_key(const std::string& name, const std::string& key_type);
            pair<string ,string>  create_keypair(const std::string& username, const string& role, const std::string& password );
            
            // get private key with the specified wallet and password + cypher in file.
            // wallet must be opened and unlocked
            string get_wallet_private_key(const std::string& name, const std::string& password );
            
        private:
            /// Verify timeout has not occurred and reset timeout if not.
            /// Calls lock_all() if timeout has passed.
            void check_timeout();
            static chain::action create_transfer(const string& contract, const name& sender, const name& recipient, chain::asset amount, const string& memo, bytes abi ) ;
